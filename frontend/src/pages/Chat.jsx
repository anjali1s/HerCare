...
function Chat() {
  ...
  return (
    <div className="chat-layout">
      ...
      <div className="floating flower-one">🌸</div>
      <div className="floating flower-two">🌷</div>
      <div className="floating flower-three">✨</div>

      <div className="sidebar">

        <div className="brand-side">
          <h2>🌸 HerCare Plus</h2>
          <p>Women's Health AI</p>
        </div>
      ...
      <div className="chat-page">
        ...
        <div className="chat-header">
          ...
          <div>
            <h2>HerCare 💗</h2>
            <p>Your caring AI companion for women's wellness 🌷</p>
          </div>
        </div>
