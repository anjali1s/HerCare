...
def add_period(
    ...
    if data.period_length < 1 or data.period_length > 10:
    ...
    if data.cycle_length < 21 or data.cycle_length > 45:
...
def get_history(
    ...
    history = db.query(
        ...
        PeriodHistory.user_id == current_user.id

    ).order_by(

        PeriodHistory.start_date.desc()
